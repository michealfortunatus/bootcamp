...
const Hero: React.FC = () => {
  return (
    <div
      className="bg-cover bg-center text-white py-20 px-4 text-center md:text-left"
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 mt-10 md:mt-0">
          <div className="relative w-40 h-40 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-white mx-auto md:mx-0">
